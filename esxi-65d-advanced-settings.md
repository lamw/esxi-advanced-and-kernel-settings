# ESXi 6.5d Build 5310538 Advanced Settings
...
| Power.PerfBias | In Custom policy, Performance Energy Bias Hint (Intel-only) | 4294967294 | 4294967294 | 4294967293 | 15 | True |
...
| VSAN-iSCSI.blockBENumThreads | Number of threads per backing file | 14 | 14 | 0 | 32 | True |
| VSAN-iSCSI.camSortIOQueues | Sort IO queues to try and optimise disk access patterns | 1 | 1 | 0 | 1 | True |
| VSAN-iSCSI.ctlInquiryPQNoLUN | return a \"bad LUN\" peripheral qualifier for unknown LUNs | 1 | 1 | 0 | 1 | True |
| VSAN-iSCSI.ctlVerbose | Show SCSI errors returned to initiator | 0 | 0 | 0 | 1 | True |
| VSAN-iSCSI.ctlWorkerThreads | Number of worker threads. -1 means auto-calculate based on CPU count | 4294967295 | 4294967295 | 1 | 16 | True |
| VSAN-iSCSI.fssBENumThreads | Number of threads servicing FSS io taskqueue | 0 | 0 | 0 | 64 | True |
| VSAN-iSCSI.iclCoalesce | Try to coalesce PDUs before sending | 0 | 0 | 0 | 1 | True |
| VSAN-iSCSI.iclPartialReceiveLen | Minimum read size for partially received data segment | 131072 | 131072 | 0 | 524288 | True |
| VSAN-iSCSI.iclRecvSpace | Default receive socket buffer size | 1048576 | 1048576 | 0 | 4194304 | True |
| VSAN-iSCSI.iclSendSpace | Default send socket buffer size | 1048576 | 1048576 | 0 | 4194304 | True |
| VSAN-iSCSI.iscsiLoginTimeout | Time to wait for vitd to finish Login Phase, in seconds | 60 | 60 | 1 | 180 | True |
| VSAN-iSCSI.iscsiMaxCmdsNDelta | Number of commands the initiator can send without confirmation | 256 | 256 | 1 | 512 | True |
| VSAN-iSCSI.iscsiPingTimeout | Interval between ping (NOP-Out) requests, in seconds | 5 | 5 | 0 | 60 | True |
| VSAN-iSCSI.scsiSettleDelay | Delay to allow devices to settle after a SCSI bus reset (ms) | 2000 | 2000 | 100 | 30000 | True |
| VSAN-iSCSI.vitLogLevel | Logging level for vit module | 4 | 4 | 0 | 10 | True |
| VSAN-iSCSI.vitPerfStats | Enable Vit module collection of performance statistics | 1 | 1 | 0 | 1 | True |
| VSAN-iSCSI.vitTraceEnable | Enables Vit module trace to vsantraces | 1 | 1 | 0 | 1 | True |
| VSAN-iSCSI.vitTraceEnableFailure | Enables Vit module failure trace to vsantraces | 1 | 1 | 0 | 1 | True |
| VSAN-iSCSI.vitTraceEnableIO | Enables Vit module I/O trace to vsantraces | 0 | 0 | 0 | 1 | True |
| VSAN-iSCSI.vitTraceEnableVerbose | Enables Vit module verbose trace to vsantraces | 0 | 0 | 0 | 1 | True |
