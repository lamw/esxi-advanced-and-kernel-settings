# ESXi 6.7 Build 8169922 Advanced Settings
...
| Misc.EnablePSPLatencyPolicy | Enable latency based sub-policy of Round-robin path selection plugin | 0 | 0 | 0 | 1 | True |
...
| Syslog.loggers.vdfsd.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.vdfsd.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
...
| Virsto.DiskFormatVersion | Virsto Disk Format version | 6 | 6 | 2 | 6 | True |
