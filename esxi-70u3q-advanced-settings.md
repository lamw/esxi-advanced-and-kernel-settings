# ESXi 7.0 Update 3q Build 23794027 Advanced Settings
...
| ScratchConfig.ConfiguredScratchLocation | The directory configured to be used for scratch space. Changes will take effect on next reboot. |  | /vmfs/volumes/664ce346-ed05a051-98c1-000c29ed3ac7 | N/A | N/A | False |
| ScratchConfig.CurrentScratchLocation | The directory currently being used for scratch space. |  | /vmfs/volumes/664ce346-ed05a051-98c1-000c29ed3ac7 | N/A | N/A | False |
...
| Syslog.global.logHost | Comma (,) separated list of remote hosts to transmit messages to. Format is: proto://hostname|ipv4|'['ipv6']'[:port]. Protocol must be one of (tcp|udp|ssl). If a port is not provided, ssl and tcp will use 1514; udp will use 514. |  |  | N/A | N/A | False |
