# ESXi 8.0 Update 3g Build 24859861 Advanced Settings
...
| LSOM.lsomEnhancedLatencyHandlingSupport | Enable latency handling optimizations in DDH. (0:disabled 1:enabled) | 0 | 0 | 0 | 1 | True |
...
| LSOM.lsomSlowTier1DeviceUnmount | Whether to auto-unmount un-healthy (pervasively slow) tier 1 devices | 0 | 0 | 0 | 1 | True |
...
| Net.EnsEnableDatapathHotswap | Enable datapath during in-place upgrade hotswap. | 0 | 0 | 0 | 1 | True |
...
| OSData.configuredLocation | The configured location of the OSData partition. |  | /vmfs/volumes/68a9e0e5-cb2cca4e-8448-000c29852592 | N/A | N/A | False |
...
| ScratchConfig.ConfiguredScratchLocation | The directory configured to be used for scratch space. Changes will take effect on next reboot. |  | /vmfs/volumes/68a9e0e5-cb2cca4e-8448-000c29852592 | N/A | N/A | False |
| ScratchConfig.CurrentScratchLocation | The directory currently being used for scratch space. |  | /vmfs/volumes/68a9e0e5-cb2cca4e-8448-000c29852592 | N/A | N/A | False |
...
| Syslog.loggers.sockrelay.rotate | Number of older log files to keep for this logger. | 0 | 16 | N/A | N/A | False |
...
| Virsto.DiskFormatVersion | Virsto Disk Format version | 20 | 20 | 2 | 20 | True |
