# ESXi 7.0 Update 2 Build 17630552 Advanced Settings
...
| ScratchConfig.ConfiguredScratchLocation | The directory configured to be used for scratch space. Changes will take effect on next reboot. |  | /vmfs/volumes/604798eb-42b84e0b-3fef-000c29900c60 | N/A | N/A | False |
| ScratchConfig.CurrentScratchLocation | The directory currently being used for scratch space. |  | /vmfs/volumes/604798eb-42b84e0b-3fef-000c29900c60 | N/A | N/A | False |
...
| Scsi.SCSIBlockUnsupportedOpcodesAndPages | Enable or disable blocking unsupported SCSI opcodes and vpd/mode pages | 0 | 0 | 0 | 1 | True |
...
| Syslog.global.logCheckSSLCerts | Enforce checking of SSL certificates when logging to a remote host. | True | True | N/A | N/A | False |
...
| Syslog.global.logHost | The remote host to output logs to. Reset to default on null. Multiple hosts are supported and must be separated with comma (,). Example: udp://hostName1:514, hostName2, ssl://hostName3:1514 |  | udp://192.168.1.200 | N/A | N/A | False |
| Syslog.loggers.LogEFI.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.LogEFI.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
...
| Syslog.loggers.apiForwarder.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.apiForwarder.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
| Syslog.loggers.attestd.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.attestd.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
...
| Syslog.loggers.cmmdsd.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.cmmdsd.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
| Syslog.loggers.crx-cli.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.crx-cli.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
...
| Syslog.loggers.esxgdpd.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.esxgdpd.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
| Syslog.loggers.esxtokend.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.esxtokend.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
...
| Syslog.loggers.etcd.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.etcd.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
| Syslog.loggers.fdm.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 10 | N/A | N/A | False |
| Syslog.loggers.fdm.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 5120 | N/A | N/A | False |
| Syslog.loggers.gstored.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.gstored.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
| Syslog.loggers.healthd.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.healthd.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
...
| Syslog.loggers.hostd.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 10 | N/A | N/A | False |
| Syslog.loggers.hostd.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 10240 | N/A | N/A | False |
...
| Syslog.loggers.ioinsight.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.ioinsight.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
| Syslog.loggers.keypersist.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.keypersist.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
| Syslog.loggers.kmxa.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.kmxa.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
| Syslog.loggers.kmxd.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.kmxd.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
...
| Syslog.loggers.lifecycle.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.lifecycle.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
...
| Syslog.loggers.localcli.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 4 | N/A | N/A | False |
| Syslog.loggers.localcli.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
...
| Syslog.loggers.sandboxd.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.sandboxd.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
...
| Syslog.loggers.settingsd.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.settingsd.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
...
| Syslog.loggers.sockrelay.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.sockrelay.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
| Syslog.loggers.spherelet.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 10 | N/A | N/A | False |
| Syslog.loggers.spherelet.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 10240 | N/A | N/A | False |
...
| Syslog.loggers.vdfs-proxy.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 16 | N/A | N/A | False |
| Syslog.loggers.vdfs-proxy.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 10240 | N/A | N/A | False |
| Syslog.loggers.vdfs-server.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 16 | N/A | N/A | False |
| Syslog.loggers.vdfs-server.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 10240 | N/A | N/A | False |
| Syslog.loggers.vdtc.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.vdtc.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
...
| Syslog.loggers.vpxa.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 10 | N/A | N/A | False |
| Syslog.loggers.vpxa.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 5120 | N/A | N/A | False |
| Syslog.loggers.vsanEsxcli.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 3 | N/A | N/A | False |
| Syslog.loggers.vsanEsxcli.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 5120 | N/A | N/A | False |
| Syslog.loggers.vsananalyticsevents.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 10 | N/A | N/A | False |
| Syslog.loggers.vsananalyticsevents.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 5120 | N/A | N/A | False |
| Syslog.loggers.vsandevicemonitord.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.vsandevicemonitord.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
| Syslog.loggers.vsanfs.configdump.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 16 | N/A | N/A | False |
| Syslog.loggers.vsanfs.configdump.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 10240 | N/A | N/A | False |
| Syslog.loggers.vsanfs.mgmt.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 32 | N/A | N/A | False |
| Syslog.loggers.vsanfs.mgmt.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 10240 | N/A | N/A | False |
| Syslog.loggers.vsanfs.vdfsop.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.vsanfs.vdfsop.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 10240 | N/A | N/A | False |
...
| VSAN.ObjectScrubsPerYear | Option to set the scrubbing rate as scrubs-per-year | 1 | 1 | 0 | 525600 | True |
...
| Virsto.DiskFormatVersion | Virsto Disk Format version | 14 | 14 | 2 | 14 | True |
