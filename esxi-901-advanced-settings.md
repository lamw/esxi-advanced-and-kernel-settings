# ESXi 9.0.1 Build 24957456 Advanced Settings
...
| Config.HostAgent.distributedTracing | Logging level for the loggers related to distributed tracing services. |  | info | N/A | N/A | False |
...
| Config.HostAgent.level[Nfcsvc].logLevel | Logging level for the loggers related to NFC services. |  | none | N/A | N/A | False |
...
| Config.HostAgent.plugins.hostsvc.esxAdminsGroupAutoAdd | Controls whether the group specified by 'esxAdminsGroup' is automatically granted administrator permission. NOTE: Changing this to false does not remove any permissions already granted to the group. | False | False | N/A | N/A | False |
...
| Config.HostAgent.plugins.solo.loglevels.module[disklib].level | Logging level for the disklib library. | 0 | 0 | N/A | N/A | False |
| Config.HostAgent.plugins.solo.loglevels.module[snapshot].level | Logging level for the snapshot library. | 0 | 0 | N/A | N/A | False |
...
| Config.HostAgent.plugins.vimsvc.authValidateInterval | Number of minutes between each validation of all known users and groups - set to zero to disable validation. | 90 | 90 | N/A | N/A | False |
| Config.HostAgent.plugins.vimsvc.disableHostProfileApi | Enables or disables Host Profile pyEngine APIs. Restart host agent service (hostd) to adopt new value. | False | False | N/A | N/A | False |
| Config.HostAgent.plugins.vimsvc.enableUtf8Filter | Enable UTF-8 validation of VIM API responses. | False | False | N/A | N/A | False |
...
| Config.HostAgent.plugins.vmsvc.allowForensicSnapshots | A flag that allows snapshots to be taken that may not be restorable. | False | False | N/A | N/A | False |
...
| Disk.VNVMEWriteZerosLimit | VNVME WriteZeros max limit in KiloBytes. The Value must be multiple of 4KB. 0 means no limit enforced. | 0 | 0 | 0 | 32768 | True |
...
| Disk.VSCSIMaxTransLen | Max transfer length in blocks for VSCSI | 0 | 0 | 0 | 16384 | True |
...
| Mem.EncryptTierNvme | Encrypt when tiering out to NVMe storage. | 0 | 0 | 0 | 1 | True |
...
| Mem.TierNvmePct | NVMe size for memory tiering (in percentage of DRAM) | 100 | 100 | 1 | 400 | True |
...
| Migrate.VMotionPreCopyAllowSwapIns | Allow pages to be swapped in during vMotion memory precopy. 0=Swapins disabled, 1=Swapins enabled only for memory tiering hosts, 2=Swapins always enabled for all hosts | 1 | 1 | 0 | 2 | True |
...
| Misc.EHVAllowDebugging | Allow a SEV/TDX guest to enable the debug policy. | 0 | 0 | 0 | 1 | True |
...
| Misc.vmmDisableL1DFlushAMD | Disable L1D flush on VM entry for AMD | 0 | 0 | 0 | 1 | True |
| Misc.vsanWitnessLicensed | Indicates whether vSAN witness license is enabled | 0 | 0 | 0 | 1 | True |
...
| Net.EnsEnableDatapathHotswap | Enable datapath during in-place upgrade hotswap. | 1 | 1 | 0 | 1 | True |
...
| Net.NetPollDispatchBudget | Number of virtual switch dispatches an uplink Rx packet list can have | 1024 | 1024 | 128 | 32768 | True |
| Net.NetPollSplitRxThres | Threshold of datapath port amount to start splitting uplink Rx packet list | 128 | 128 | 32 | 10000 | True |
...
| Net.NetSchedHeapMaxSizeMB | Size of the netsched subsystem heap in MB | 66 | 66 | 1 | 96 | True |
...
| Net.ReversePathFwdCheckPromisc | Block duplicate packet in a teamed environment when the virtual switch is set to Promiscuous mode. | 1 | 1 | 0 | 1 | True |
...
| Net.TcpipRxDispatchQueues | Max # of dispatch queues used for RX. 0 for autotuning based on PCPU count. For low memory systems, this should be minimum value(REQUIRES REBOOT!) | 0 | 0 | 0 | 8 | True |
...
| Net.TeamingIgnoreShotgun | Ignore the shotgun capability in Teaming | 0 | 0 | 0 | 1 | True |
...
| Net.Vmxnet3EnsRxMultipleContexts | Use multiple ENS contexts for vnic RX processing. 0 relies on vmx option, 1 for globally enable, 2 for globally disable. | 0 | 0 | 0 | 2 | True |
...
| Net.Vmxnet3PageInBound | max # pageIn requests to handle per helper call for vmxnet3. | 256 | 256 | 1 | 1024 | True |
...
| Numa.DeviceAffinity | 1: ESXi will automatically attempt to place a virtual machine on NUMA nodes where its configured passthrough devices reside, 0: default virtual machine placement behavior | 0 | 0 | 0 | 1 | True |
...
| Numa.PageMigRateMax | max page migration rate | 32000 | 32000 | 0 | 8000000 | True |
...
| Numa.RebalancePeriod | Frequency of NUMA node rebalancing in milliseconds | 2000 | 2000 | 1 | 60000 | True |
...
| OSData.configuredLocation | The configured location of the OSData partition. |  | /vmfs/volumes/68dd4ebd-11ed1366-ed6d-000c296d44fd | N/A | N/A | False |
| Power.CStateMaxLatency | In Custom policy, avoid a C-state whose latency is larger than this value (us) | 1000 | 1000 | 0 | 1000000 | True |
...
| Power.MaxCpuLoad | In Custom policy, CPU utilization threshold below which CPU frequency can be dynamically adjusted. This parameter is not used when CPPC is enabled. | 60 | 60 | 0 | 100 | True |
...
| Power.TimerHz | In Custom policy, dynamic power management timer sampling rate for ACPI P-states. When CPPC is enabled, used only for debugging. | 100 | 100 | 1 | 1000 | True |
| Power.UseCStates | In Custom policy, use ACPI C-states when processor is idle | 1 | 1 | 0 | 1 | True |
| Power.UsePStates | In Custom policy, use ACPI P-states or CPPC to save power when processor is busy | 1 | 1 | 0 | 1 | True |
| RdmFilter.HbaIsShared | Allow local disks to be RDM candidates for Virtual Machines | False | True | N/A | N/A | False |
| ScratchConfig.ConfiguredScratchLocation | The directory configured to be used for scratch space. Changes will take effect on next reboot. |  | /vmfs/volumes/68dd4ebd-11ed1366-ed6d-000c296d44fd | N/A | N/A | False |
| ScratchConfig.CurrentScratchLocation | The directory currently being used for scratch space. |  | /vmfs/volumes/68dd4ebd-11ed1366-ed6d-000c296d44fd | N/A | N/A | False |
...
| Scsi.NvmeLogVerbose | Enable verbose logging  for NVMe devices. This is a bitwise value and can be combined. 1 = Log every command, 2 = Log ANA log page, 4 = Log ANA log page namespace list, 8 = Verbose logging | 0 | 0 | 0 | 15 | True |
| Scsi.NvmeMaxUnmapBlockDescriptorCount | Set maximum deallocate (unmap) descriptor count limit | 0 | 0 | 0 | 256 | True |
| Scsi.NvmeMaxUnmapBlockDescriptorLbaCount | Set maximum deallocate (unmap) lba limit per descriptor | 0 | 0 | 0 | 4294967295 | True |
| Scsi.NvmeMaxUnmapLbaCount | Set maximum deallocate (unmap) size limit (in blocks) | 0 | 0 | 0 | 4294967295 | True |
| Scsi.NvmeMaxWriteZeroLbaCount | Set maximum write zero lba limit | 0 | 0 | 0 | 4294967295 | True |
...
| Security.PasswordHistory | Number of passwords to remember for each user. Zero disables password history. | 5 | 5 | N/A | N/A | False |
...
| Security.PasswordQualityControl | Raw options for pam_passwdqc PAM module. This value is used as is in PAM's configuration file, so use with caution. This setting is in effect only if PasswordQualityControlPwquality is set to the string 'UNUSED'. | random=0 retry=3 min=disabled,disabled,disabled,7,7 | random=0 retry=3 min=disabled,disabled,disabled,7,7 | N/A | N/A | False |
...
| Syslog.loggers.catalog.rotate | Number of older log files to keep for this logger. | 0 | 16 | N/A | N/A | False |
| Syslog.loggers.catalog.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 10240 | N/A | N/A | False |
| Syslog.loggers.clomd-whatif.rotate | Number of older log files to keep for this logger. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.clomd-whatif.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 1024 | N/A | N/A | False |
...
| Syslog.loggers.dfwpktlogs.rotate | Number of older log files to keep for this logger. | 0 | 10 | N/A | N/A | False |
| Syslog.loggers.dfwpktlogs.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 10240 | N/A | N/A | False |
...
| Syslog.loggers.dlbaccslogs.rotate | Number of older log files to keep for this logger. | 0 | 10 | N/A | N/A | False |
| Syslog.loggers.dlbaccslogs.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 10240 | N/A | N/A | False |
...
| Syslog.loggers.entropyd.rotate | Number of older log files to keep for this logger. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.entropyd.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 1024 | N/A | N/A | False |
| Syslog.loggers.envoy-access.rotate | Number of older log files to keep for this logger. | 0 | 10 | N/A | N/A | False |
| Syslog.loggers.envoy-access.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 10240 | N/A | N/A | False |
...
| Syslog.loggers.nsx-idps-events.rotate | Number of older log files to keep for this logger. | 0 | 10 | N/A | N/A | False |
| Syslog.loggers.nsx-idps-events.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 10240 | N/A | N/A | False |
| Syslog.loggers.nsx-syslog.rotate | Number of older log files to keep for this logger. | 0 | 28 | N/A | N/A | False |
| Syslog.loggers.nsx-syslog.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 32768 | N/A | N/A | False |
| Syslog.loggers.nsxaVim.rotate | Number of older log files to keep for this logger. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.nsxaVim.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 1024 | N/A | N/A | False |
| Syslog.loggers.nsxdavim.rotate | Number of older log files to keep for this logger. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.nsxdavim.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 1024 | N/A | N/A | False |
| Syslog.loggers.opslldpvim.rotate | Number of older log files to keep for this logger. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.opslldpvim.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 1024 | N/A | N/A | False |
| Syslog.loggers.osfsd.rotate | Number of older log files to keep for this logger. | 0 | 10 | N/A | N/A | False |
| Syslog.loggers.osfsd.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 2048 | N/A | N/A | False |
...
| Syslog.loggers.sensord.rotate | Number of older log files to keep for this logger. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.sensord.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 1024 | N/A | N/A | False |
...
| Syslog.loggers.sockrelay.rotate | Number of older log files to keep for this logger. | 0 | 64 | N/A | N/A | False |
| Syslog.loggers.sockrelay.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 20480 | N/A | N/A | False |
...
| Syslog.loggers.vds-vsipioctl.rotate | Number of older log files to keep for this logger. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.vds-vsipioctl.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 1024 | N/A | N/A | False |
...
| Syslog.loggers.vmkmemstats.rotate | Number of older log files to keep for this logger. | 0 | 20 | N/A | N/A | False |
| Syslog.loggers.vmkmemstats.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 5120 | N/A | N/A | False |
...
| Syslog.loggers.vsanfs.mgmt.rotate | Number of older log files to keep for this logger. | 0 | 90 | N/A | N/A | False |
| Syslog.loggers.vsanfs.mgmt.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 20480 | N/A | N/A | False |
| Syslog.loggers.vsanfs.monitor.rotate | Number of older log files to keep for this logger. | 0 | 90 | N/A | N/A | False |
| Syslog.loggers.vsanfs.monitor.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 20480 | N/A | N/A | False |
...
| Syslog.loggers.watchdog.rotate | Number of older log files to keep for this logger. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.watchdog.size | Size of each log file before switching to another for this logger (in KiB). | 0 | 1024 | N/A | N/A | False |
...
| UserVars.AuditApiCallEnabled | This option controls the emission of the 'api.call' audit event. A reboot is required for this setting to take affect. | 0 | 0 | 0 | 1 | True |
...
| UserVars.ESXiVPsDisabledProtocols | ESXi VPs disabled protocols (Deprecated). All protocols prior to tlsv1.2 are no longer supported and must remain disabled. | sslv3,tlsv1,tlsv1.1 | sslv3,tlsv1,tlsv1.1 | N/A | N/A | True |
...
| VMkernel.Boot.disableHwrng | Disable hardware random number generator (RDRAND, RDSEED). Overrides VMkernel.Boot.entropySources. | False | False | N/A | N/A | False |
...
| VMkernel.Boot.earlyUWDumpEnabled | Enable Userworld Coredumps during boot. | False | False | N/A | N/A | False |
| VMkernel.Boot.enableACSCheckForRP | Enable ACS capability checks for Root Port | False | False | N/A | N/A | False |
| VMkernel.Boot.enableACSDTP2P | Enable/Disable ACS Direct translated P2P | True | True | N/A | N/A | False |
| VMkernel.Boot.ensMbufPoolMaxMBPerGB | Maximum MB of ENS mbuf pool to be allocated per GB of physical memory. Maximum value for this setting is 512. ENS mbuf pool maximum per system will be at least 656MB. | 200 | 200 | 0 | 4294967295 | False |
| VMkernel.Boot.ensMbufPoolMaxMinMB | Upper limit of ENS mbuf pool minimum per system in MB. | 5000 | 5000 | 0 | 4294967295 | False |
| VMkernel.Boot.ensMbufPoolMinMBPerGB | Minimum MB of ENS mbuf pool to be allocated per GB of physical memory. | 10 | 10 | 0 | 4294967295 | False |
| VMkernel.Boot.entropySources | Which entropy sources to enable. 0=defaults, otherwise bitmask values: 1=interrupts, 2=RDRAND, 4=RDSEED, 8=entropyd. If RDSEED is supported, the default is FIPS compliance. Otherwise the default is all entropy sources except entropyd. | 0 | 0 | 0 | 4294967295 | False |
| VMkernel.Boot.execInstalledOnly | Execute only those files that have been installed via a vib package and have not been modified. | True | True | N/A | N/A | False |
...
| VMkernel.Boot.haltOnBootDeviceLoss | Halt the system if the boot device accessibility is lost | False | False | N/A | N/A | False |
...
| VMkernel.Boot.heapPoisonPaddingBytes | Number of additional poisoned red zone bytes for allocations | 4 | 4 | 0 | 4294967295 | False |
...
| VMkernel.Boot.memoryTiering | Enable Memory Tiering | False | False | N/A | N/A | False |
...
| VMkernel.Boot.netNetqueueEnblSwlroWithPnicHwlro | Enable/Disable SWLRO for PNIC with HWLRO. Requires REBOOT. | True | True | N/A | N/A | False |
...
| VMkernel.Boot.netNetqueuePortFeatInheritance | Enable/Disable Inheritance of queue feature of port filter for learned mac filter's. Requires REBOOT. | True | True | N/A | N/A | False |
...
| VMkernel.Boot.netPktJumboSlabMinSize | Minimum size of packet jumbo frame slab in MB | 0 | 0 | 0 | 4294967295 | False |
...
| VMkernel.Boot.rtcEnableLegacyForce | Enable legacy CMOS device as real time clock even if FADT has the CMOS RTC Not Present flag set | False | False | N/A | N/A | False |
...
| VMkernel.Boot.storageEnablePrpAtPsa | Enable NVMe PRP handling in PSA | True | True | N/A | N/A | False |
...
| VMkernel.Boot.useHWP | Use Intel Hardware P-states if available for ESXi power management. If set to FALSE, use legacy P-states if available.  This option is supported on Intel Sapphire Rapids onward. | True | True | N/A | N/A | False |
...
| VMkernel.Boot.visorfsSwap | Enable VisorFS swap if the system matches the required criteria (auto) | False | False | N/A | N/A | False |
...
| VSAN.MultiTierEnableFastPath | Eanble PSA fastpath for vSAN ESA multi-tier storagepool | 0 | 0 | 0 | 1 | True |
| VSAN.MultiTierVMFSReserveMB | Space reserved for vSAN ESA multi-tier storagepool used VMFS-L volume | 200 | 200 | 0 | 10240 | True |
...
| VVOL.allowLegacyCiphers | Allow vVOL daemon to use legacy cipher for TLS communication with VASA Provider [Warning: Non-PFS ciphers!] | 0 | 0 | 0 | 1 | True |
...
| Virsto.DiskFormatVersion | Virsto Disk Format version | 22 | 22 | 2 | 22 | True |
