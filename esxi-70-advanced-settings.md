# ESXi 7.0 Build 15843807 Advanced Settings
...
| Disk.SanitizeSupport | Sanitize support for disks. | 0 | 0 | 0 | 1 | True |
...
| LSOM.lsomEnableFullRebuildAvoidance | Enable LSOM full rebuild avoidance for transient IO errors. (0:disabled 1:enabled) | 0 | 0 | 0 | 1 | True |
...
| ScratchConfig.ConfiguredScratchLocation | The directory configured to be used for scratch space. Changes will take effect on next reboot. |  | /vmfs/volumes/5e85bfb4-e360bfec-9c5e-000c29fd11e7 | N/A | N/A | False |
| ScratchConfig.CurrentScratchLocation | The directory currently being used for scratch space. |  | /vmfs/volumes/5e85bfb4-e360bfec-9c5e-000c29fd11e7 | N/A | N/A | False |
...
| Syslog.loggers.esxapiadapter.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
| Syslog.loggers.esxapiadapter.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 1024 | N/A | N/A | False |
...
| Syslog.loggers.vdfs-proxy.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
...
| Syslog.loggers.vdfs-server.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 8 | N/A | N/A | False |
...
| Syslog.loggers.vpxa.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 20 | N/A | N/A | False |
...
| Syslog.loggers.vsandpd.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 10 | N/A | N/A | False |
| Syslog.loggers.vsandpd.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 10240 | N/A | N/A | False |
...
| Syslog.loggers.vsanfs.mgmt.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 16 | N/A | N/A | False |
...
| Syslog.loggers.vsanrpd.rotate | Number of rotated logs to keep for this logger. Reset to default on zero. | 0 | 10 | N/A | N/A | False |
| Syslog.loggers.vsanrpd.size | Set size of logs before rotation for this logger, in KiB. Reset to default on zero. | 0 | 10240 | N/A | N/A | False |
...
| UserVars.ProductLockerLocation | Path to VMware Tools and vSphere Client repository |  |  | N/A | N/A | True |
...
| VMkernel.Boot.logEFILevel | Specifies how much should be logged to LogEFI | 1 | 1 | N/A | N/A | False |
...
| Virsto.DiskFormatVersion | Virsto Disk Format version | 11 | 11 | 2 | 11 | True |
